...
int main()
{
    ...
    geomObjectArray[0] = toString(p0);
    geomObjectArray[1] = toString(p1);
    geomObjectArray[2] = toString(p2);
    geomObjectArray[3] = toString(seg); 
    geomObjectArray[4] = toString(s1);
    geomObjectArray[5] = toString(s2);


    geomObjectArray[6] = toString(circ);
    geomObjectArray[7] = toString(p);

    geomObjectArray[8] = toString(tri);
    geomObjectArray[9] = toString(p);
    geomObjectArray[10] = toString(q);
    geomObjectArray[11] = toString(s);

    geomObjectArray[12] = toString(rect);
    geomObjectArray[13] = toString(p);
    geomObjectArray[14] = toString(q);



    
   
    printToFile("test.txt", geomObjectArray, 15);
}
